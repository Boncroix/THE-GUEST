...
- NIVEL_CON_HABILIDADES = Nos indica a partir de que nivel se activan las habilidades especiales de la nave.
...
# Carpeta resources
- Se encuentran todos recursos utilizados para crear el juego.
